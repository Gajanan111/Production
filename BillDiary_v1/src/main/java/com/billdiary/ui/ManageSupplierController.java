...
public class ManageSupplierController implements Initializable {
	...
	private void editButtonClickedThroughHyperlink(int supID, int index) {
	...
	private void deleteButtonClickedThroughHyperlink(int supID,int rowIndex) {
