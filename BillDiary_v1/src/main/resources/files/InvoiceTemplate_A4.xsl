		...
		<fo:root xmlns:fo="http://www.w3.org/1999/XSL/Format">
			...
			<fo:page-sequence master-reference="simpleA4">
				<fo:flow flow-name="xsl-region-body">
					...
					<fo:block>
					<fo:inline font-size="12pt"  >Name:<fo:inline font-weight="bold" >
					<xsl:value-of select="NameOfClient"/></fo:inline>
					</fo:inline>
					<fo:inline font-size="12pt"  padding-left="200pt"  text-align="right" > Date:<fo:inline font-weight="bold">
					 <xsl:value-of select="date"/> </fo:inline>
					</fo:inline>
					</fo:block>
					
					<fo:block font-size="12pt" space-after="5mm" margin-top="0.8cm"> Address:<fo:inline font-weight="bold">
					 <xsl:value-of select="Address"/></fo:inline>
					</fo:block>
					<fo:block font-size="12pt" space-after="5mm">Mobile no:<fo:inline font-weight="bold">
					 <xsl:value-of select="phone"/></fo:inline>
					</fo:block>
					<fo:block>
